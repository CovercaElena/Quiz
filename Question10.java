...
public class Question10 extends javax.swing.JFrame {
    ...
    public Question10(BTree players, QTree questions, String nume,List<Integer>numbers,String punctaj)
    {
        initComponents();
    ...
    private void NextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NextMouseClicked
        ...
        String punctaj=Punctaj.getText();
        Final f=new Final(players,questions,name,punctaj);
        f.setVisible(true);
        this.dispose();
