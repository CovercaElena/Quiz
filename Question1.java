...
public class Question1 extends javax.swing.JFrame {
    ...
    public Question1(BTree players, QTree questions, String nume,List<Integer>numbers)
    {
        initComponents();
        this.players=players;
        this.questions=questions;
    ...
    private void NextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NextMouseClicked
        // TODO add your handling code here:
        Question2 f=new Question2(this.getPlayers(),this.getQuestions(),Name.getText(),numbers,Punctaj.getText());
        f.setVisible(true);
        this.dispose();
